...
type DrillDownType = 'employee' | 'department' | 'reason' | null;
  ...
  return (
    <div className="min-h-full bg-ink-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {hasFilter && (
          <div className="bg-accent-50 border border-accent-200 rounded-xl p-3 mb-5 flex items-center justify-between animate-fade-up">
            ...
            <button onClick={clearDrill} className="text-sm text-accent-700 hover:text-accent-800 font-medium flex items-center gap-1">
