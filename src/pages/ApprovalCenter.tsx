...
import { Check, X, Clock, Users, Calendar, MessageSquare, ArrowRightLeft, AlertTriangle, Search, Building2, Zap } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-card overflow-hidden animate-fade-up animate-stagger-1">
          ...
          <div className="divide-y divide-ink-100 max-h-[calc(100vh-280px)] overflow-y-auto scrollbar-thin">
            {loading ? (
              ...
              filtered.map((a, i) => {
                const isAutoApproved = (a as any).autoApproved;
                return (
